  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground">
      <div className="container mx-auto flex max-w-[64rem] flex-col items-center px-4 py-16 text-center sm:py-32 md:px-8">
        ...
        <h2 className="mb-8 text-2xl font-semibold sm:text-3xl md:text-4xl">Page Not Found</h2>
        <p className="mb-8 max-w-lg text-muted-foreground sm:text-lg">
          Oops! The page you're looking for seems to have wandered off. It might be exploring the digital wilderness or
          taking a well-deserved vacation in cyberspace.
        </p>
